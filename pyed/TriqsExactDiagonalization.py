...
class TriqsExactDiagonalization(object):
    ...
    def set_g40_tau(self, g40_tau, g_tau):
        ...
        for t1, t2, t3 in g40_tau.mesh:
            ...
            g40_tau[t1, t2, t3] = val(
                g_tau, t12) * val(g_tau, t3) - val(g_tau, t1) * val(g_tau, t32)
    ...
    def set_g40_tau_matrix(self, g40_tau, g_tau):
        ...
        for t1, t2, t3 in g40_tau.mesh:
            ...
            g40_tau[t1, t2, t3] += np.einsum('ba,dc->abcd',
                                             val(g_tau, t1 - t2), val(g_tau, t3))
            g40_tau[t1, t2, t3] -= np.einsum('da,bc->abcd',
                                             val(g_tau, t1), val(g_tau, t3 - t2))
    ...
    def set_g4_tau_matrix(self, g4_tau, op_list):
        ...
        for (i1, o1), (i2, o2), (i3, o3), (i4, o4) in \
            ...
            self.set_g4_tau(g4_tau[i1, i2, i3, i4], o1,
                            dagger(o2), o3, dagger(o4))
